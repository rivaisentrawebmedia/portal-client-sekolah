...
interface TablePeriodeCutiProps {
	data: PeriodeCuti[];
	page: number;
	limit: number;
	search: string;
...
export function TablePeriodeCuti({
	data,
	page,
	limit,
	search,
	loading,
}: TablePeriodeCutiProps) {
	return (
		<BaseTable
			data={data}
			loading={loading}
			search={search}
			emptyTitle="Belum ada data Periode Cuti"
			emptyDescription="Silakan tambahkan data Periode Cuti terlebih dahulu"
			columns={[
				{
					header: "#",

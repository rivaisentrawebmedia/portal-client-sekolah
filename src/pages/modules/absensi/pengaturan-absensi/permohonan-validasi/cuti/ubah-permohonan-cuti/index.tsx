...
import { useUpdatePermohonanCuti } from "../layout/controller";
...
import { FormData } from "../buat-permohonan-cuti/components";

export default function EditPermohonanCutiPage() {
	const navigate = useNavigate();
	const [params] = useSearchParams();

	const { form, disabled, isShow, onSubmit, setIsShow } =
		useUpdatePermohonanCuti();
			...
			<Dialog open={isShow} onOpenChange={setIsShow}>
				<DialogContent className="w-[95vw] max-w-md rounded-lg p-6 max-h-[90vh]">
					<DialogHeader>
						...
						<DialogDescription>
							Apakah anda yakin ingin menyimpan perubahan pada permohonan cuti
							berikut ini?
						</DialogDescription>
					</DialogHeader>

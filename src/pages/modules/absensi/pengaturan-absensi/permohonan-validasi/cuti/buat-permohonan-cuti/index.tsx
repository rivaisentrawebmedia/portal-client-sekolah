...
import { usePostPermohonanCuti } from "../layout/controller";
...
export default function TambahPermohonanCutiPage() {
	const navigate = useNavigate();
	const [params] = useSearchParams();

	const { form, disabled, isShow, onSubmit, setIsShow } =
		usePostPermohonanCuti();
		...
		<>
				...
				<Breadcrumbs
					items={[
						...
						},
						{
							...
							to: `/modules/presensi/pengaturan-absensi/permohonan-validasi/cuti?${params.toString()}`,
						},
						{
							label: "Buat Permohonan Cuti",
						},
					]}
				/>
			...
			<Dialog open={isShow} onOpenChange={setIsShow}>
				<DialogContent className="w-[95vw] max-w-md rounded-lg p-6 max-h-[90vh]">
					<DialogHeader>
						<DialogTitle>Buat Permohonan Cuti</DialogTitle>
						<DialogDescription>
							Apakah anda yakin ingin membuat permohonan cuti berikut ini?
						</DialogDescription>
					</DialogHeader>

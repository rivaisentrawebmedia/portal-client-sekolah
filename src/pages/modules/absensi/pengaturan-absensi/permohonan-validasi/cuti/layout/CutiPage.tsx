...
import type { GetPermohonanCutiParams } from "./model/dataAPI";
import {
	useGetPermohonanCuti,
	usePostStatusPermohonanCuti,
} from "./controller";
import { Pagination } from "@/components/common/pagination";
import { useState } from "react";
import { DialogData } from "../detail-permohonan-cuti/components/button/DialogData";
...
export default function PermohonanCutiPage() {
	...
	const paramsDefault: GetPermohonanCutiParams = {
		page: Number(page) || 1,
	...
	const { data, loading, meta } = useGetPermohonanCuti(paramsDefault);
		...
		<>
			<div className="flex flex-col gap-4 w-full">
				...
				<div className="flex flex-row items-center justify-between gap-4">
					<p className="text-2xl text-[#1E5916] font-medium">Permohonan Cuti</p>
					<ButtonTambah />
				</div>

...
import {
	useGetPermohonanIzinByID,
	usePostStatusPermohonanIzin,
} from "../list-permohonan-izin/controller";
...
export default function DetailPermohonanIzinPage() {
	const [searchParams] = useSearchParams();

	const { data: detail, loading } = useGetPermohonanIzinByID();
		...
		<>
			<div className="flex flex-col gap-4 w-full">
				<Breadcrumbs
					items={[
						...
						},
						{
							...
							to: `/modules/presensi/pengaturan-absensi/permohonan-validasi/izin?${searchParams.toString()}`,
						},
						{
				...
				<>
					...
					<InformasiPegawai />
					<DetailIzin detail={detail} loading={loading} />
				</>
			</div>

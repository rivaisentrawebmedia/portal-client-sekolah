...
import { useUpdateManajemenUser } from "../../list-user/controller";
import {
	FormInformasiAkun,
	FormInformasiClient,
	FormInformasiPegawai,
} from "../../tambah-user/info-akun/components";

export default function EditInformasiAkunPage() {
	const { disabled, form, isShow, onSubmit, setIsShow } =
		useUpdateManajemenUser();

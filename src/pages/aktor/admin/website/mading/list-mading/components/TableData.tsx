...
import { ButtonPublishMading } from "./ButtonPublish";
...
export function TableMadingDraft({
	data,
	page,
	limit,
	search,
	...
	return (
		<BaseTable
			...
			search={search}
			background="#F5F9FF"
			emptyTitle="Belum ada data Mading"
			emptyDescription="Silakan tambahkan data Mading terlebih dahulu"
			columns={[
				{
					header: "#",
				...
				},
				{
					header: "Kategori",
					className: "font-light text-[#276CCD]",
					render: (item) => <p>{item?.kategori_mading || "-"}</p>,
				},
				{
					...
					render: (item) => {
						return (
							<div className="flex flex-col gap-2">
								...
								<ButtonPublishMading rowData={item} />
							</div>
						);
					},
				},
...
export function TableMadingPublish({
	data,
	page,
	limit,
	search,

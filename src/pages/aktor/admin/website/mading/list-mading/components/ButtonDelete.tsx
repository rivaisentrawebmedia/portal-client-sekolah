...
import { useDeleteMading } from "../controller";
import {
	Dialog,
	DialogContent,
	DialogDescription,
...
export function ButtonDelete({ rowData }: { rowData?: Mading }) {
		...
		<>
			...
			<Dialog open={isShow} onOpenChange={setIsShow}>
				<DialogContent className="w-[95vw] max-w-md rounded-lg p-6 max-h-[90vh]">
					<DialogHeader>
						<DialogTitle>Hapus Mading</DialogTitle>
						<DialogDescription>
							Apakah anda yakin ingin menghapus Mading ini?
						</DialogDescription>
					</DialogHeader>

...
export function DashboardMadingTerbaru() {
	const navigate = useNavigate();
	const [searchParams] = useSearchParams();

	const page = searchParams.get("page-mading-terbaru");
	const limit = searchParams.get("limit-mading-terbaru");
	const search = searchParams.get("search-mading-terbaru");
	...
	return (
		<div className="flex flex-col gap-2 bg-[#F5F9FF] rounded-md p-3 border border-[#70A6F2]">
			<p className="text-[#276CCD] font-medium">Mading Terbaru</p>

...
export function ButtonPublishMading({ rowData }: { rowData?: Mading }) {
		...
		<>
			...
			<Dialog open={isShow} onOpenChange={setIsShow}>
				<DialogContent className="w-[95vw] max-w-md rounded-lg p-6 max-h-[90vh]">
					<DialogHeader>
						<DialogTitle>Publish Mading</DialogTitle>
						<DialogDescription>
							Anda akan mempublish mading dan mading akan dapat dibaca oleh

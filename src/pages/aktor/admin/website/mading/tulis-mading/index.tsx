...
export default function TulisMadingPage() {
	const navigate = useNavigate();
	const [params] = useSearchParams();
	const { disabled, form, isShow, onSubmit, setIsShow } = usePostMading();
		...
		<>
					...
					<div className="flex flex-col gap-2 md:flex-row md:justify-between md:gap-4">
						...
						<div className="flex gap-2 flex-col md:flex-row">
							<Button
								...
								onClick={() => {
									navigate(`/admin/website/mading/tulis-mading`);
								}}
								variant={"outline"}
							>
								<X />
			...
			<Dialog open={isShow} onOpenChange={setIsShow}>
				<DialogContent className="w-[95vw] max-w-md rounded-lg p-6 max-h-[90vh]">
					<DialogHeader>
						<DialogTitle>Tulis Mading</DialogTitle>
						<DialogDescription>
							Apakah anda yakin ingin menyimpan mading ini?
						</DialogDescription>
					</DialogHeader>

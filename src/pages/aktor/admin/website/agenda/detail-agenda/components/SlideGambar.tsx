...
export function SlideGambar({ data }: { data: Agenda | undefined }) {
	...
	return (
		<div className="relative w-full md:w-1/4 overflow-hidden rounded-md">
			<img
				src={current?.id}
				alt={current?.label || `Gambar ${idx + 1}`}
				className="h-60 w-full transition-all duration-300"
			/>

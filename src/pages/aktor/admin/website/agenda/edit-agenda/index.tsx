...
import { FormUploadGambar } from "../tulis-agenda/FormUploadGambar";
import {
	InputCommon,
	SelectCommon,
	TextEditorCommon,
...
export default function EditAgendaPage() {
	...
	const { disabled, form, isShow, onSubmit, setIsShow } = useUpdateAgenda();
					...
					<div className="flex flex-col gap-2 md:flex-row md:justify-between md:gap-4">
						...
						<div className="flex gap-2 md:flex-row flex-col">
							<Button
								...
								onClick={() => {
									navigate(`/modules/modul-website/agenda`);
								}}
								variant={"outline"}
							>
								<X />

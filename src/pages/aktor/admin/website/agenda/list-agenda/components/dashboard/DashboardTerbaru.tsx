...
export function DashboardAgendaTerbaru() {
	const navigate = useNavigate();
	const [searchParams] = useSearchParams();

	const page = searchParams.get("page-agenda-terbaru");
	const limit = searchParams.get("limit-agenda-terbaru");
	const search = searchParams.get("search-agenda-terbaru");
	...
	return (
		<div className="flex flex-col gap-2 bg-[#F5F9FF] rounded-md p-3 border border-[#70A6F2]">
			<p className="text-[#276CCD] font-medium">Agenda Terbaru</p>

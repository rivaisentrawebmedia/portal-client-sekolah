...
import { ButtonPublishAgenda } from "./ButtonPublish";
...
export function TableAgendaDraft({
	data,
	page,
	limit,
	search,
	...
	return (
		<BaseTable
			...
			search={search}
			background="#F5F9FF"
			emptyTitle="Belum ada data Agenda"
			emptyDescription="Silakan tambahkan data Agenda terlebih dahulu"
			columns={[
				{
					header: "#",
				...
				},
				{
					header: "Kategori",
					className: "font-light text-[#276CCD]",
					render: (item) => <p>{item?.kategori_agenda || "-"}</p>,
				},
				{
					...
					render: (item) => {
						return (
							<div className="flex flex-col gap-2">
								...
								<ButtonPublishAgenda rowData={item} />
							</div>
						);
					},
				},
...
export function TableAgendaPublish({
	data,
	page,
	limit,
	search,

...
import { usePostStatusStatusPrestasi } from "../controller";

export function ButtonKembaliKeDraft({ rowData }: { rowData?: Prestasi }) {
			...
			<Dialog open={isShow} onOpenChange={setIsShow}>
				<DialogContent className="w-[95vw] max-w-md rounded-lg p-6 max-h-[90vh]">
					<DialogHeader>
						...
						<DialogDescription>
							Anda akan mengembalikan Prestasi ke draft dan Prestasi tidak dapat

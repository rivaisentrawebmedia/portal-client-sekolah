...
import { useGetPrestasiStats } from "../../controller";
...
export function DashboardStats() {
	const { data: dataStat, loading: loadingStat } = useGetPrestasiStats();

	const listState = [
		{
			title: "Jumlah Prestasi",
			value: dataStat?.jumlah_prestasi,
			icon: <JokoNewspaper />,
		},
		{
			title: "Jumlah Dibaca",

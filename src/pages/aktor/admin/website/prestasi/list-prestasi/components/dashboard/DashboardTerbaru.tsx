...
export function DashboardPrestasiTerbaru() {
	const navigate = useNavigate();
	const [searchParams] = useSearchParams();

	const page = searchParams.get("page-prestasi-terbaru");
	const limit = searchParams.get("limit-prestasi-terbaru");
	const search = searchParams.get("search-prestasi-terbaru");
	...
	return (
		<div className="flex flex-col gap-2 bg-[#F5F9FF] rounded-md p-3 border border-[#70A6F2]">
			<p className="text-[#276CCD] font-medium">Prestasi Terbaru</p>

...
import { FormUploadGambar } from "../tulis-prestasi/FormUploadGambar";
import {
	InputCommon,
	SelectCommon,
	TextEditorCommon,
...
export default function EditPrestasiPage() {
	...
	const { disabled, form, isShow, onSubmit, setIsShow } = useUpdatePrestasi();
					...
					<div className="flex flex-col gap-2 md:flex-row md:justify-between md:gap-4">
						...
						<div className="flex gap-2 md:flex-row flex-col">
							<Button
								...
								onClick={() => {
									navigate(`/modules/modul-website/prestasi`);
								}}
								variant={"outline"}
							>
								<X />
			...
			<Dialog open={isShow} onOpenChange={setIsShow}>
				<DialogContent className="w-[95vw] max-w-md rounded-lg p-6 max-h-[90vh]">
					<DialogHeader>
						...
						<DialogDescription>
							Apakah anda yakin ingin menyimpan perubahan pada Prestasi ini?
						</DialogDescription>
					</DialogHeader>

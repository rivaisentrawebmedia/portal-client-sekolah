...
import { FormUploadGambar } from "../tulis-pengumuman/FormUploadGambar";
import {
	InputCommon,
	SelectCommon,
	TextEditorCommon,
...
export default function EditPengumumanPage() {
	...
	const { disabled, form, isShow, onSubmit, setIsShow } = useUpdatePengumuman();
					...
					<div className="flex flex-col gap-2 md:flex-row md:justify-between md:gap-4">
						...
						<div className="flex gap-2 md:flex-row flex-col">
							<Button
								...
								onClick={() => {
									navigate(`/modules/modul-website/pengumuman`);
								}}
								variant={"outline"}
							>
								<X />

						...
						{form.watch(name) ? (
							<div className="flex gap-2">
								<img
									src={form.watch(name) || ""}
									alt={label}
									className="w-32 h-32 rounded-md bg-[#F5F9FF]"
								/>
							...
							<div className="flex gap-2">
								<div className="flex flex-col w-32 h-32 bg-[#F5F9FF] border border-[#DFDFDF] gap-2 items-center justify-center">
									<JokoAddPhoto />
								</div>
								<div className="flex flex-col justify-center gap-2">
									<p className="font-medium">{label}</p>
									<ol className="list-disc text-xs text-[#0e4087] font-light ml-4">
										<li>Max 2MB</li>
										<li>Berjenis .jpg/.jpeg/,png</li>
									</ol>
									<div className="flex items-center text-[#0e4087] cursor-pointer gap-2 py-1.5 px-4 text-xs w-fit border border-#DFDFDF] rounded-full">
										<FaUpload />
										Upload
									</div>
								</div>

...
import { DialogData } from "../../pengaturan-absensi/permohonan-validasi/izin/detail-permohonan-izin/components/button/DialogData";
import {
	ButtonBatalkan,
	ButtonSetuju,
	ButtonTolak,
} from "../../pengaturan-absensi/permohonan-validasi/izin/detail-permohonan-izin/components/button";
import type { NotifikasiPengajuanCuti } from "../model";
import { usePostStatusPermohonanIzin } from "../../pengaturan-absensi/permohonan-validasi/izin/list-permohonan-izin/controller";

export function ButtonIzin({ item }: { item: NotifikasiPengajuanCuti }) {

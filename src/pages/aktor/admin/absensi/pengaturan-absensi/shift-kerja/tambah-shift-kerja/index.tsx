...
import { usePostShiftKerja } from "../list-shift-kerja/controller";
import { FormPengaturan, FormShiftKerja, FormTambahShift } from "./components";
import { InputCommon } from "@/components/common/basic-input";

export default function TambahShiftKerjaPage() {
	const navigate = useNavigate();

	const { form, disabled, isShow, onSubmit, setIsShow } = usePostShiftKerja();
		...
		<>
			...
			<Dialog open={isShow} onOpenChange={setIsShow}>
				<DialogContent className="w-[95vw] max-w-md rounded-lg p-6 max-h-[90vh]">
					<DialogHeader>
						<DialogTitle>Buat Shift Kerja</DialogTitle>
						<DialogDescription>
							Apakah anda yakin ingin membuat Shift Kerja berikut ini?
						</DialogDescription>
					</DialogHeader>

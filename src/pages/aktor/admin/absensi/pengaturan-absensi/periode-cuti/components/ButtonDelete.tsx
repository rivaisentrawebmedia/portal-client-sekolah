...
import { useDeletePeriodeCuti } from "../controller";
import {
	Dialog,
	DialogContent,
	DialogDescription,
...
export function ButtonDelete({ rowData }: { rowData?: PeriodeCuti }) {
	const { disabled, setIsShow, setSelected, handleDelete, isShow, selected } =
		useDeletePeriodeCuti();
		...
		<>
			...
			<Dialog open={isShow} onOpenChange={setIsShow}>
				<DialogContent className="w-[95vw] max-w-md rounded-lg p-6 max-h-[90vh]">
					<DialogHeader>
						<DialogTitle>Hapus Periode Cuti</DialogTitle>
						<DialogDescription>
							Apakah anda yakin ingin menghapus Periode Cuti ini?
						</DialogDescription>
					</DialogHeader>
